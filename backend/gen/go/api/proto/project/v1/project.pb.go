...
var file_api_proto_project_v1_project_proto_goTypes = []interface{}{
...
func file_api_proto_project_v1_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_proto_project_v1_project_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_proto_project_v1_project_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
