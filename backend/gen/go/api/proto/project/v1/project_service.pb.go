...
const file_api_proto_project_v1_project_service_proto_rawDesc = "" +
	"\n" +
	"*api/proto/project/v1/project_service.proto\x12\x17cyclonedx_ui.project.v1\x1a\x1cgoogle/api/annotations.proto\x1a\"api/proto/project/v1/project.proto\x1a#api/proto/project/v1/revision.proto\"\xae\x01\n" +
	"\x13ProjectsQueryFilter\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\x12\x12\n" +
	"\x04tags\x18\x04 \x03(\tR\x04tags\x12\x1b\n" +
	"\x06offset\x18\x05 \x01(\x04H\x00R\x06offset\x88\x01\x01\x12\x19\n" +
	"\x05limit\x18\x06 \x01(\x04H\x01R\x05limit\x88\x01\x01B\t\n" +
	"\a_offsetB\b\n" +
	"\x06_limit\"D\n" +
	"\fProjectsList\x124\n" +
	"\x04list\x18\x01 \x03(\v2 .cyclonedx_ui.project.v1.ProjectR\x04list\"\x8c\x01\n" +
	...
	"revisionIdB\r\n" +
	"\vproject_uid\"\x16\n" +
	"\x14ProjectCreateOptions2\xfb\x06\n" +
	"\x0eProjectService\x12\x89\x01\n" +
	"\x18GetProjectsByQueryFilter\x12,.cyclonedx_ui.project.v1.ProjectsQueryFilter\x1a%.cyclonedx_ui.project.v1.ProjectsList\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/api/v1/projects\x12\x96\x01\n" +
	"\n" +
	"GetProject\x12,.cyclonedx_ui.project.v1.ProjectsQueryFilter\x1a .cyclonedx_ui.project.v1.Project\"8\x82\xd3\xe4\x93\x022Z\x19\x12\x17/api/v1/projects/{slug}\x12\x15/api/v1/projects/{id}\x12p\n" +
	"\rCreateProject\x12 .cyclonedx_ui.project.v1.Project\x1a .cyclonedx_ui.project.v1.Project\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\x1a\x10/api/v1/projects\x12u\n" +
	"\rUpdateProject\x12 .cyclonedx_ui.project.v1.Project\x1a .cyclonedx_ui.project.v1.Project\" \x82\xd3\xe4\x93\x02\x1a:\x01*2\x15/api/v1/projects/{id}\x12\xcc\x01\n" +
	"\x12GetProjectRevision\x12-.cyclonedx_ui.project.v1.ProjectRevisionQuery\x1a!.cyclonedx_ui.project.v1.Revision\"d\x82\xd3\xe4\x93\x02^Z/\x12-/api/v1/projects/{project_slug}/{revision_id}\x12+/api/v1/projects/{project_id}/{revision_id}\x12\x8b\x01\n" +
	"\x15UpdateProjectRevision\x12!.cyclonedx_ui.project.v1.Revision\x1a .cyclonedx_ui.project.v1.Project\"-\x82\xd3\xe4\x93\x02':\x01*2\"/api/v1/projects/{project_id}/{id}BHZFgithub.com/Qvineox/cyclonedx-ui/gen/go/api/proto/project/v1;project_v1b\x06proto3"
